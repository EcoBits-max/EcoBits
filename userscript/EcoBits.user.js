...
function loadUI(){
 $('body').append(`
<div class="minions-col" style="width: 50px; margin-top: 4px;">
		<a href="http://ecobits.rf.gd/" ><img class="logo" width="85%" src="https://b.imge.to/2019/12/11/vzHiZ2.jpg"> </div>
	<div class="minions-col">
		<div class="minions-box">
			<div class="minions-content">
				<div class="minions-row"></div>
				<div id="minions-alive" class="minions-row"> Minions </div> </div>
				<div id="botCount"></div>
				<div class="minions-bar-back">
				<div id="minions-bar-bots" style="width: 100%;background-color: rgba(223,9,5);">
			</div>
		</div>
	</div>
</div>
	<div class="minions-col">
		<div class="minions-box">
			<div class="minions-content">
				<div class="minions-row"></div>
				<div id="minions-alive" class="minions-row"> Server </div> </div>
				<div id="userStatus"></div>
				<div class="minions-bar-back">
				<div id="minions-bar-bots" style="width: 100%;background-color: rgb(255);">
			</div>
		</div>
	</div>
</div>
	<div class="minions-col">
		<div class="minions-box">
			<div class="minions-content">
				<div class="minions-row"></div>
				<div id="minions-alive" class="minions-row"> Bots AI </div> </div>
				<div id="botsAI"></div>
				<div class="minions-bar-back">
				<div id="minions-bar-bots" style="width: 100%;background-color: rgb(257, 255, 7);">
			</div>
		</div>
	</div>
</div>
